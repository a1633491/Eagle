  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex flex-col-reverse gap-3 sm:flex-row sm:items-center'>
        <button
          type='button'
          className='inline-flex h-14 w-full items-center justify-center rounded-[18px] border border-white/10 bg-[#1a1b18] px-5 text-sm font-medium text-[#e4e1d5] transition hover:bg-[#1f201d] sm:w-[180px]'
        >
          {locale.saveDraft}
        </button>
        <button
          ...
          className='inline-flex h-14 w-full items-center justify-center rounded-[18px] border border-[#f6e3ac66] bg-[linear-gradient(145deg,#efe1b2,#d6c38a)] px-5 text-base font-medium text-[#342d1a] transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60 sm:flex-1'
        >
          {isBusy ? '...' : primaryLabel}
        </button>
      </div>
