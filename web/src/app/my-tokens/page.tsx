    ...
    <div className='min-h-screen bg-[#151714]'>
      ...
      <main className='mx-auto flex w-full max-w-[760px] flex-col px-4 pb-16 pt-12'>
        <section className='flex flex-col items-center text-center'>
          ...
          <h1 className='mt-4 text-[2.55rem] font-semibold tracking-[-0.065em] text-[#f3f1e8]'>{t(lang, 'somethingBrewing')}</h1>
        ...
        <section className='mt-14 rounded-[28px] border border-white/8 bg-[#1a1c19]/96 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.22)]'>
          <p className='text-[11px] font-medium uppercase tracking-[0.2em] text-[#8f9482]'>{t(lang, 'create')}</p>
          <h2 className='mt-3 text-[1.8rem] font-semibold tracking-[-0.05em] text-[#f3f1e8]'>{t(lang, 'yourFirstIdea')}</h2>
