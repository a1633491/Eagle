      ...
      sections: [
        {
          ...
          index: '01',
          title: '创建代币',
          body: `zero 会把你的代币直接发射到 ${chainNameZh} 上的 ${launchVenueZh} 池子。创建确认并完成索引后，代币会出现在 Explore，并拥有自己的详情页。`,
          steps: [
        ...
        },
        {
          ...
          steps: [`可以用配对资产或 ${nativeSymbol} 买入。`, '报价会跟随交易刷新，开始交易和授权之后 zero 都会重新获取最新报价。'],
        },
        {
          id: 'fees',
          index: '04',
          title: '费用与奖励',
          body: '通过 zero 发射池进行的交易会收取 1% 池子费用。配对资产侧的费用会在创作者费用接收地址和协议之间分配。',
        ...
        },
        {
          ...
          index: '05',
          title: '合约地址',
          body: `以下是 zero 在 ${chainNameZh} 主网使用的合约地址，Chain ID ${chainId}。你可以复制地址或直接在 ${explorerName} 打开。`,
          contracts,
        },
        {
          id: 'questions',
          index: '06',
          title: '常见问题',
          body: '请使用已安装并启用钱包扩展的浏览器，或者钱包自带浏览器。先解锁钱包，再允许它连接到 zero。',
          steps: [
      ...
      sections: [
        {
          ...
          index: '01',
          title: 'トークン作成',
          body: `zero はあなたのトークンを ${chainNameJa} 上の ${launchVenueJa} プールへ直接ローンチします。ローンチが確定してインデックスされると、トークンは Explore に表示され、専用ページを持ちます。`,
          steps: [
        ...
        },
        {
          ...
          steps: [`ペア資産または ${nativeSymbol} で購入できます。`, '見積もりは取引に合わせて更新され、開始時と承認後に zero が再取得します。'],
        },
        {
          id: 'fees',
          index: '04',
          title: '手数料と報酬',
          body: 'zero のローンチプールを通る取引には 1% のプール手数料がかかります。ペア資産側の手数料は、クリエイター受取先とプロトコルに分配されます。',
        ...
        },
        {
          ...
          index: '05',
          title: 'コントラクト',
          body: `以下は zero が ${chainNameJa} mainnet で使用するコントラクトです。Chain ID は ${chainId}。アドレスをコピーするか、${explorerName} で開けます。`,
          contracts,
        },
        {
          id: 'questions',
          index: '06',
          title: 'よくある質問',
          body: 'ウォレット拡張が有効なブラウザ、またはウォレット内ブラウザを使用してください。ウォレットを解除し、zero への接続を許可します。',
          steps: [
    ...
    sections: [
      {
        ...
        body: `zero launches your token directly into a ${launchVenueEn} pool on ${chainNameEn}. Once the launch is confirmed and indexed, your token appears in Explore with its own page.`,
        steps: [
      ...
      },
      {
        ...
        steps: [
          `${nativeSymbol}: Use ${chainNameEn}'s native coin. zero uses ${wrappedNativeName} inside the pool.`,
      ...
      },
      {
        ...
        steps: [
          ...
          'Your quote follows the trade. zero refreshes the quote when you begin the trade and again after approval.',
        ],
      },
      {
        id: 'fees',
        index: '04',
        title: 'Fees & rewards',
        body: 'Trades through a zero launch pool carry a 1% pool fee. Paired-token fees are split between the creator’s fee recipient and the protocol.',
        steps: [
      ...
      },
      {
        ...
        index: '05',
        title: 'Contracts',
        body: `The contract addresses used by zero on ${chainNameEn} mainnet · Chain ID ${chainId}. Copy an address or open it on ${explorerName}.`,
        contracts,
      },
      {
        id: 'questions',
        ...
        body: 'Use a browser with your wallet extension installed and enabled, or your wallet’s own browser. Unlock the wallet and allow it to connect to zero.',
        steps: [
